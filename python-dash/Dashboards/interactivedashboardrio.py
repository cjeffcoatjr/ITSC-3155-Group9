...
stackbarchart_df = df.apply(lambda x: x.str.strip() if x.dtype == "object" else x)
...
# Bubble chart
bubble_df = df.apply(lambda x: x.str.strip() if x.dtype == "object" else x)
...
app.layout = html.Div(children=[
    ...
    html.H3('Interactive Bar chart', style={'color': '#dfe56'}),
    ...
    html.Br(),
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Bar chart', style={'color': '#dfe56'}),
    ...
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Stack bar chart', style={'color': '#dfe56'}),
    html.Div(
    ...
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Line chart', style={'color': '#dfe56'}),
    ...
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Multi Line chart', style={'color': '#dfe56'}),
    html.Div(
    ...
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Bubble chart', style={'color': '#dfe56'}),
    html.Div(
    ...
    html.Hr(style={'color': '#7FDBFF'}),
    html.H3('Heat map', style={'color': '#dfe56'}),
    html.Div(
